...
while True:
	...
	def selfscan():
		...
		sec1()
		green("self.WPA_DISABLE = False ")
		sec1()
		sec1()
		green("self.WPA_STRIP_HANDSHAKE = True")
		green("self.WPA_DEAUTH_COUNT = 1  ")
		print("")
		sec1()
		green("self.WPA_DEAUTH_TIMEOUT = 10  ")
		s2()
		green("self.WPA_ATTACK_TIMEOUT = 500 ")
		s2()
		green("self.WPA_HANDSHAKE_DIR = 'hs'")
		sec1()
		green("self.WPA_HANDSHAKE_TSHARK = True")   
		s2()
		green("self.WPA_HANDSHAKE_PYRIT = False")
		s2()
		green("self.WPA_HANDSHAKE_AIRCRACK = True")
		s2()
		green("self.WPA_HANDSHAKE_COWPATTY = False")
		s2()
	...
	print(f"\033[2;49;93m PassWord: \033[m \033[2;49;91m {senha}{cac}42022\033[m")
	input("")
